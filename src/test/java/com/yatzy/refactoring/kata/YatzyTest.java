...
public class YatzyTest {
    ...
    @Test
    public void score_pair_test() {
        assertEquals(6, Yatzy.score_pair(3,4,3,5,6));
        assertEquals(10, Yatzy.score_pair(5,3,3,3,5));
        assertEquals(12, Yatzy.score_pair(5,3,6,6,5));
        assertEquals(0, Yatzy.score_pair(1,2,3,6,5));
        assertEquals(2, Yatzy.score_pair(1,1,3,5,6));
        assertEquals(2, Yatzy.score_pair(1,1,1,1,1));
        assertEquals(10, Yatzy.score_pair(2,2,5,5,3));
    }
    ...
    public void two_Pair_test() {
        ...
        assertEquals(0, Yatzy.two_pair(1,1,1,1,1));
        assertEquals(10, Yatzy.two_pair(1,1,1,4,4));
        assertEquals(0, Yatzy.two_pair(1,1,1,4,6));
    }
    ...
    public void three_of_a_kind_test()
    {
        ...
        assertEquals(0, Yatzy.three_of_a_kind(1,2,3,4,3));
    }
    ...
    public void four_of_a_kind_test() {
        ...
        assertEquals(0, Yatzy.four_of_a_kind(5,4,3,5,5));
    ...
    public void fullHouse_test() {
        ...
        assertEquals(0, Yatzy.fullHouse(6,6,2,2,3));
